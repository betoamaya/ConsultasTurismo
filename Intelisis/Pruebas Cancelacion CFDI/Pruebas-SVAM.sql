...
SELECT c.MovID,
       ...
       *
FROM dbo.CFD AS c
WHERE c.MovID IN ( 'TVE138517', 'TVE138518', 'TVE138520', 'TVE138531' );
/*
MovID		UUID
================================================
...
WHERE MovID IN ( 'TVE138517', 'TVE138518', 'TVE138520', 'TVE138531' );
...
SELECT c.MovID,
       ...
       *
FROM dbo.CFD AS c
WHERE c.MovID IN ( 'TVE138521', 'TVE138522', 'TVE138523', 'TVE138530' );
/*
MovID		UUID
================================================
...
WHERE MovID IN ( 'TVE138521', 'TVE138522', 'TVE138523', 'TVE138530' );
